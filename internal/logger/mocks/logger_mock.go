...
// Source: github.com/trsv-dev/simple-windows-services-monitor/internal/logger (interfaces: Logger)
...
import (
	...
	logger "github.com/trsv-dev/simple-windows-services-monitor/internal/logger"
)
...
func (m *MockLogger) Debug(arg0 string, arg1 ...logger.Field) {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Error(arg0 string, arg1 ...logger.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (m *MockLogger) Warn(arg0 string, arg1 ...logger.Field) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
