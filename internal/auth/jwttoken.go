...
func BuildJWTToken(user *models.User) (string, error) {
...
func SetLoginToContext(tokenString string, w http.ResponseWriter, r *http.Request) (http.ResponseWriter, *http.Request) {
	login, err := GetLogin(tokenString)
	if err != nil {
