...
// UserID — это уникальный тип ключа для хранения UserID пользователя в контексте.
// Определяем новый тип struct{}, чтобы избежать конфликтов с другими ключами.
type userID struct{}

// UserID — единственный экземпляр ключа userID, который нужно использовать для сохранения
// и получения значения id пользователя из context.Context.
var UserID = userID{}

// serverID — это уникальный тип ключа для хранения id сервера в контексте.
// Определяем новый тип struct{}, чтобы избежать конфликтов с другими ключами.
type serverID struct{}

// ServerID — единственный экземпляр ключа id, который нужно использовать для сохранения
// и получения значения id сервера из context.Context.
var ServerID = serverID{}

// serviceID — это уникальный тип ключа для хранения id службы в контексте.
// Определяем новый тип struct{}, чтобы избежать конфликтов с другими ключами.
type serviceID struct{}

// ServiceID — единственный экземпляр ключа id, который нужно использовать для сохранения
// и получения значения id службы из context.Context.
