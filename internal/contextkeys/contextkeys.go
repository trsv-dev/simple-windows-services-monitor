...
// idKey — это уникальный тип ключа для хранения id сервера или службы в контексте.
// Определяем новый тип struct{}, чтобы избежать конфликтов с другими ключами.
type idKey struct{}

// IDKey — единственный экземпляр ключа id, который нужно использовать для сохранения
// и получения значения id сервера или службы из context.Context.
var IDKey = idKey{}
